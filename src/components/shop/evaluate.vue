  ...
  <div class="evaluate">
    ...
    <div class="top-score">
      ...
      <div class="right-content">
        <div class="service"><span class="title">服务态度</span><v-star :score="goods_score" :size="36"></v-star><span class="score">{{service_score}}</span></div>
        <div class="goods-evaluate"><span class="title">菜品评价</span><v-star :score="goods_score" :size="36"></v-star><span class="score" v-text="goods_score"></span></div>
...
<style>
  ...
  .top-score .right-content .service,.top-score .right-content .goods-evaluate,.top-score .right-content .send-time{
    font-size:0px;
    color:rgb(7,17,27);
    margin-bottom:8px;
  }
